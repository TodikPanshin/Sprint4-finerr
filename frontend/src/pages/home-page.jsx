    ...
    return (
        <main className="home-page main-layout">
            <div className="slide-container">
                ...
                <div style={{ opacity: getOpacity(1), transiton: "1.5s" }}><img src={hero_URLs[1]} alt="slide-images-gallery" /><p>Andrea, <span>Fashion Designer</span></p></div>
                <div style={{ opacity: getOpacity(2), transiton: "1.5s" }}><img src={hero_URLs[2]} alt="slide-images-gallery" /><p>⭐⭐⭐⭐⭐<br />Moon, <span>Marketing Expert</span></p></div>
                <div style={{ opacity: getOpacity(3), transiton: "1.5s" }}><img src={hero_URLs[3]} alt="slide-images-gallery" /><p>Ritika, <span>Shoemaker and Designer</span></p></div>
                <div style={{ opacity: getOpacity(4), transiton: "1.5s" }}><img src={hero_URLs[4]} alt="slide-images-gallery" /><p>Zach, <span>Bar Owner</span></p></div>
                <div style={{ opacity: getOpacity(5), transiton: "1.5s" }}><img src={hero_URLs[5]} alt="slide-images-gallery" /><p>⭐⭐⭐⭐⭐<br />Gabrielle, <span>Video Editor</span></p></div>
            </div>
